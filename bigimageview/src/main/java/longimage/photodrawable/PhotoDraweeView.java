...
public class PhotoDraweeView extends SimpleDraweeView implements IAttacher {
    ...
    public void setGestureEnable(boolean enable) {
        mAttacher.setCanresponseGesture(enable);
    }
    ...
    public void fillWidth(int imageInfoWidth, int imageInfoHeight) {
        mAttacher.fillWidth(imageInfoWidth, imageInfoHeight);
    }
}
