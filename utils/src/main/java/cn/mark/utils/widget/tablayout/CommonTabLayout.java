package cn.mark.utils.widget.tablayout;
...
import cn.mark.utils.widget.tablayout.utils.FragmentChangeManager;
import cn.mark.utils.widget.tablayout.utils.UnreadMsgUtils;
import cn.mark.utils.widget.tablayout.view.MsgView;

/***
 * @author marks.luo
 * @Description: TODO(没有继承HorizontalScrollView不能滑动, 对于ViewPager无依赖)
 * @date:2017-04-25 15:37
 */
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_height,
                DPToPx.dp2px(mContext, mIndicatorStyle == STYLE_TRIANGLE ? 4 : (mIndicatorStyle == STYLE_BLOCK ? -1 : 2)));
        mIndicatorWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_width, DPToPx.dp2px(mContext, mIndicatorStyle == STYLE_TRIANGLE ? 10 : -1));
        mIndicatorCornerRadius = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_corner_radius, DPToPx.dp2px(mContext, mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorMarginLeft = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_left, DPToPx.dp2px(mContext, 0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_top, DPToPx.dp2px(mContext, mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorMarginRight = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_right, DPToPx.dp2px(mContext, 0));
        mIndicatorMarginBottom = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_bottom, DPToPx.dp2px(mContext, mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        ...
        mUnderlineHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_underline_height, DPToPx.dp2px(mContext, 0));
        ...
        mDividerWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_divider_width, DPToPx.dp2px(mContext, 0));
        mDividerPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_divider_padding, DPToPx.dp2px(mContext, 12));

        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, DPToPx.sp2px(mContext, 13f));
        ...
        mIconWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_iconWidth, DPToPx.dp2px(mContext, 0));
        mIconHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_iconHeight, DPToPx.dp2px(mContext, 0));
        mIconMargin = ta.getDimension(R.styleable.CommonTabLayout_tl_iconMargin, DPToPx.dp2px(mContext, 2.5f));

        mTabSpaceEqual = ta.getBoolean(R.styleable.CommonTabLayout_tl_tab_space_equal, true);
        mTabWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_width, DPToPx.dp2px(mContext, -1));
        mTabPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? DPToPx.dp2px(mContext, 0) : DPToPx.dp2px(mContext, 10));
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setTabPadding(float tabPadding) {
        this.mTabPadding = DPToPx.dp2px(mContext, tabPadding);
        updateTabStyles();
    }
    ...
    public void setTabWidth(float tabWidth) {
        this.mTabWidth = DPToPx.dp2px(mContext, tabWidth);
        updateTabStyles();
    }
    ...
    public void setIndicatorHeight(float indicatorHeight) {
        this.mIndicatorHeight = DPToPx.dp2px(mContext, indicatorHeight);
        invalidate();
    }

    public void setIndicatorWidth(float indicatorWidth) {
        this.mIndicatorWidth = DPToPx.dp2px(mContext, indicatorWidth);
        invalidate();
    }

    public void setIndicatorCornerRadius(float indicatorCornerRadius) {
        this.mIndicatorCornerRadius = DPToPx.dp2px(mContext, indicatorCornerRadius);
        invalidate();
    }
    ...
    public void setIndicatorMargin(float indicatorMarginLeft, float indicatorMarginTop,
        ...
        this.mIndicatorMarginLeft = DPToPx.dp2px(mContext, indicatorMarginLeft);
        this.mIndicatorMarginTop = DPToPx.dp2px(mContext, indicatorMarginTop);
        this.mIndicatorMarginRight = DPToPx.dp2px(mContext, indicatorMarginRight);
        this.mIndicatorMarginBottom = DPToPx.dp2px(mContext, indicatorMarginBottom);
        invalidate();
    }
    ...
    public void setUnderlineHeight(float underlineHeight) {
        this.mUnderlineHeight = DPToPx.dp2px(mContext, underlineHeight);
        invalidate();
    }
    ...
    public void setDividerWidth(float dividerWidth) {
        this.mDividerWidth = DPToPx.dp2px(mContext, dividerWidth);
        invalidate();
    }

    public void setDividerPadding(float dividerPadding) {
        this.mDividerPadding = DPToPx.dp2px(mContext, dividerPadding);
        invalidate();
    }

    public void setTextsize(float textsize) {
        this.mTextsize = DPToPx.sp2px(mContext,textsize);
        updateTabStyles();
    }
    ...
    public void setIconWidth(float iconWidth) {
        this.mIconWidth = DPToPx.dp2px(mContext, iconWidth);
        updateTabStyles();
    }

    public void setIconHeight(float iconHeight) {
        this.mIconHeight = DPToPx.dp2px(mContext, iconHeight);
        updateTabStyles();
    }

    public void setIconMargin(float iconMargin) {
        this.mIconMargin = DPToPx.dp2px(mContext, iconMargin);
        updateTabStyles();
    }
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            if (mIconGravity == Gravity.TOP || mIconGravity == Gravity.BOTTOM) {
                lp.leftMargin = DPToPx.dp2px(mContext, leftPadding);
                lp.topMargin = mHeight > 0 ? (int) (mHeight - textHeight - iconH - margin) / 2 - DPToPx.dp2px(mContext, bottomPadding) : DPToPx.dp2px(mContext, bottomPadding);
            } else {
                lp.leftMargin = DPToPx.dp2px(mContext, leftPadding);
                lp.topMargin = mHeight > 0 ? (int) (mHeight - Math.max(textHeight, iconH)) / 2 - DPToPx.dp2px(mContext, bottomPadding) : DPToPx.dp2px(mContext, bottomPadding);
            }
