...
public class SlidingTabLayout extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_width, DPToPx.dp2px(mContext, mIndicatorStyle == STYLE_TRIANGLE ? 10 : -1));
        mIndicatorCornerRadius = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_corner_radius, DPToPx.dp2px(mContext, mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorMarginLeft = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_left, DPToPx.dp2px(mContext, 0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_top, DPToPx.dp2px(mContext, mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorMarginRight = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_right, DPToPx.dp2px(mContext, 0));
        mIndicatorMarginBottom = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_bottom, DPToPx.dp2px(mContext, mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        ...
        mUnderlineHeight = ta.getDimension(R.styleable.SlidingTabLayout_tl_underline_height, DPToPx.dp2px(mContext, 0));
        ...
        mDividerWidth = ta.getDimension(R.styleable.SlidingTabLayout_tl_divider_width, DPToPx.dp2px(mContext, 0));
        mDividerPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_divider_padding, DPToPx.dp2px(mContext, 12));

        mTextsize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textsize, DPToPx.sp2px(mContext, 14));
        ...
        mTabWidth = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_width, DPToPx.dp2px(mContext, -1));
        mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? DPToPx.dp2px(mContext, 0) : DPToPx.dp2px(mContext, 20));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            lp.leftMargin = mTabWidth >= 0 ? (int) (mTabWidth / 2 + textWidth / 2 + DPToPx.dp2px(mContext, leftPadding)) : (int) (mTabPadding + textWidth + DPToPx.dp2px(mContext, leftPadding));
            lp.topMargin = mHeight > 0 ? (int) (mHeight - textHeight) / 2 - DPToPx.dp2px(mContext, bottomPadding) : 0;
