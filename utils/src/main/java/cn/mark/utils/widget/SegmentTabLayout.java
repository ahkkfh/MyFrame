...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorMarginLeft = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_left, DPToPx.dp2px(mContext, 0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_top, 0);
        mIndicatorMarginRight = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_right, DPToPx.dp2px(mContext, 0));
        ...
        mDividerWidth = ta.getDimension(R.styleable.SegmentTabLayout_tl_divider_width, DPToPx.dp2px(mContext, 1));
        mDividerPadding = ta.getDimension(R.styleable.SegmentTabLayout_tl_divider_padding, 0);

        mTextsize = ta.getDimension(R.styleable.SegmentTabLayout_tl_textsize, DPToPx.sp2px(mContext, 13f));
        ...
        mTabWidth = ta.getDimension(R.styleable.SegmentTabLayout_tl_tab_width, DPToPx.dp2px(mContext, -1));
        mTabPadding = ta.getDimension(R.styleable.SegmentTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? DPToPx.dp2px(mContext, 0) : DPToPx.dp2px(mContext, 10));
        ...
        mBarStrokeWidth = ta.getDimension(R.styleable.SegmentTabLayout_tl_bar_stroke_width, DPToPx.dp2px(mContext, 1));
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            lp.topMargin = mHeight > 0 ? (int) (mHeight - textHeight) / 2 - DPToPx.dp2px(mContext, bottomPadding) : DPToPx.dp2px(mContext, bottomPadding);
